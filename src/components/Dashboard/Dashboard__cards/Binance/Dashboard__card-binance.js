...
import './Dashboard__card-binance.css'
...
const  DashboardCardBinance = () => {
  ...
  return <div className='Dasboard__card-binance__wrapper'>
    ...
    <h3 className='Dashboard__card__title'>1220</h3>
...
export default DashboardCardBinance
